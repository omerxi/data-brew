...
for ID in "EVTC001100001" 
# `cat idlist.txt` 	# "EVTC001100001" # "EVTC075140343"
do
  echo "For person $ID"
  ...
  #>>>>>>>>> java -jar -DconfigFile=../silk/foaf_name.vcard_street-adress/configFile.xml -DlogQueries=true $SILK/silk.jar
done
